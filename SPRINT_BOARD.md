...
| FIX-08 | JR | S | P0 BUG: Potions not available at shop — shop inventory missing potions | MERGED (PR #124) |
| GD-16 | GD | M | Card rarity visuals — distinct borders/glow for common, uncommon, rare | MERGED (PR #125) |
| UX-21 | UX | M | Run history & statistics — past runs, win/loss, per-character stats | MERGED (PR #126) |
...
| BE-24 | BE | S | Act 3 balance tuning — adjust stats based on QA-13 data | MERGED (PR #133) |
...
| GD-19 | GD | M | Animated boss sprites — CSS idle animations for 3 key bosses | MERGED (PR #142) |
...
| GD-20 | GD | S | Heart art — enemy sprite + Act 4 background | DONE (pre-existing) |
| JR-11 | JR | S | Heart card interactions — 60+ card edge case audit vs Heart mechanics | MERGED (PR #146) |
| UX-25 | UX | S | Updated self-assessment — re-score for 90+ target | MERGED (PR #147) |
...
| GD-25 | GD | M | Enemy art quality pass — improve 5 Act 1 boss/elite sprites | MERGED (PR #171) |
...
| Task | Owner | Size | Description | Status |
|------|-------|------|-------------|--------|
| BE-33 | BE | M | Bundle code-splitting — break 1.2MB index chunk into smaller chunks | PENDING |
| GD-30 | GD | M | Relic & potion compendium — browsable collection with discovery tracking | PENDING |
...
| Task | Owner | Size | Description | Status |
|------|-------|------|-------------|--------|
| UX-34 | UX | S | Achievement notification toasts — in-game popups on unlock | PENDING |
