...
**Branch:** `sprint-8`
**Status:** PLANNED — 14 tasks (6 P0 + 5 P1 + 2 P2 stretch + 1 deferred carry)

### P0 — Must Ship

| Task | Owner | Size | Description | Status |
|------|-------|------|-------------|--------|
| GD-10 | GD | M | Title screen — professional dark fantasy first impression | PENDING |
...
| GD-09 | GD | M | Missing enemy art (7 sprites) + sprite sheet rebuild (41 enemies) | PENDING |

### P1 — Should Ship

| Task | Owner | Size | Description | Status |
|------|-------|------|-------------|--------|
| UX-14 | UX | M | Mobile map screen — touch-friendly nodes, path planning | PENDING |
...
| JR-06 | JR | S | Bronze Orbs + Stasis — Automaton companion mechanic | PENDING |
