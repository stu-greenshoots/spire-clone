...
export const ALL_CARDS = [
  ...
  },
  {
    ...
    character: 'defect',
    cost: 1,
    special: 'channelLightning',
    description: 'Channel 1 Lightning.',
    upgraded: false,
    upgradedVersion: { cost: 0, description: 'Channel 1 Lightning.' }
  },
  {
    id: 'dualcast',
    name: 'Dualcast',
    ...
    upgraded: false,
    upgradedVersion: { cost: 0, description: 'Evoke your next Orb twice.' }
  },
  ...
  // ========== DEFECT COMMON ATTACKS ==========
  {
    ...
    upgraded: false,
    upgradedVersion: { damage: 10, description: 'Deal 10 damage. Channel 1 Lightning.' }
  },
  {
    id: 'coldSnap',
    name: 'Cold Snap',
    ...
    cost: 1,
    damage: 6,
    special: 'channelFrost',
    description: 'Deal 6 damage. Channel 1 Frost.',
    upgraded: false,
    upgradedVersion: { damage: 9, description: 'Deal 9 damage. Channel 1 Frost.' }
  },
  {
    id: 'beamCell',
    name: 'Beam Cell',
    ...
    upgraded: false,
    upgradedVersion: { damage: 4, effects: [{ type: 'vulnerable', amount: 2 }], description: 'Deal 4 damage. Apply 2 Vulnerable.' }
  },
  {
    id: 'compileDrive',
    name: 'Compile Driver',
    ...
    upgraded: false,
    upgradedVersion: { damage: 10, description: 'Deal 10 damage. Draw 1 card for each unique Orb type you have.' }
  },
  {
    id: 'sweepingBeam',
    name: 'Sweeping Beam',
    ...
    upgraded: false,
    upgradedVersion: { damage: 9, description: 'Deal 9 damage to ALL enemies. Draw 1 card.' }
  },
  ...
  // ========== DEFECT COMMON SKILLS ==========
  {
    ...
    upgraded: false,
    upgradedVersion: { draw: 2, description: 'Channel 1 Frost. Draw 2 cards.' }
  },
  {
    id: 'chargeUp',
    name: 'Charge Battery',
    ...
    block: 7,
    special: 'channelLightning',
    description: 'Gain 7 Block. Channel 1 Lightning.',
    upgraded: false,
    upgradedVersion: { block: 10, description: 'Gain 10 Block. Channel 1 Lightning.' }
  },
  {
    id: 'leapDefect',
    name: 'Leap',
    ...
    upgraded: false,
    upgradedVersion: { block: 12, description: 'Gain 12 Block.' }
  },
  {
    id: 'steamBarrier',
    name: 'Steam Barrier',
    ...
    cost: 0,
    block: 6,
    special: 'steamBarrier',
    description: 'Gain 6 Block. Block decreases by 1 this combat.',
    upgraded: false,
    upgradedVersion: { block: 8, description: 'Gain 8 Block. Block decreases by 1 this combat.' }
  },
  {
    id: 'stackDefect',
    name: 'Stack',
    ...
    character: 'defect',
    cost: 1,
    special: 'blockPerDiscard',
    description: 'Gain Block equal to the number of cards in your discard pile.',
    upgraded: false,
    upgradedVersion: { description: 'Gain Block equal to the number of cards in your discard pile +3.', blockBonus: 3 }
  },
  ...
  // ========== DEFECT UNCOMMON ATTACKS ==========
  {
    ...
    upgraded: false,
    upgradedVersion: { damage: 14, description: 'Deal 14 damage to ALL enemies. Channel 1 Dark.' }
  },
  {
    id: 'blizzard',
    name: 'Blizzard',
    ...
    cost: 1,
    targetAll: true,
    special: 'blizzardDamage',
    description: 'Deal damage to ALL enemies equal to 2x the number of Frost channeled this combat.',
    upgraded: false,
    upgradedVersion: { description: 'Deal damage to ALL enemies equal to 3x the number of Frost channeled this combat.', blizzardMultiplier: 3 }
  },
  {
    id: 'ftl',
    name: 'FTL',
  ...
  },
  {
    ...
    upgraded: false,
    upgradedVersion: { damage: 9, description: 'Deal 9 damage twice.' }
  },
  ...
  // ========== DEFECT UNCOMMON SKILLS ==========
  {
    ...
    upgraded: false,
    upgradedVersion: { block: 10, description: 'Gain 10 Block. Channel 2 Frost.' }
  },
  {
    id: 'consume',
    name: 'Consume',
    ...
    upgraded: false,
    upgradedVersion: { description: 'Gain 3 Focus. Lose 1 Orb slot.', focusAmount: 3 }
  },
  {
    id: 'defragment',
    name: 'Defragment',
    ...
    upgraded: false,
    upgradedVersion: { focusAmount: 2, description: 'Gain 2 Focus.' }
  },
  {
    id: 'capacitor',
    name: 'Capacitor',
    ...
    upgraded: false,
    upgradedVersion: { orbSlotGain: 3, description: 'Gain 3 Orb slots.' }
  },
  {
    id: 'equilibrium',
    name: 'Equilibrium',
  ...
  // ========== DEFECT RARE ATTACKS ==========
  {
    ...
    upgraded: false,
    upgradedVersion: { damage: 34, description: 'Deal 34 damage to ALL enemies. Lose 3 Focus.' }
  },
  {
    id: 'meteorStrike',
    name: 'Meteor Strike',
  ...
  // ========== DEFECT RARE SKILLS ==========
  {
    ...
    seekCount: 1,
    exhaust: true,
    description: 'Put 1 card from your draw pile into your hand. Exhaust.',
    upgraded: false,
    upgradedVersion: { seekCount: 2, description: 'Put 2 cards from your draw pile into your hand. Exhaust.' }
  },
  ...
  // ========== DEFECT RARE POWERS ==========
  {
    ...
    upgraded: false,
    upgradedVersion: { cost: 2, description: 'At the start of each turn, add a random Power card to your hand.' }
  },
  {
    id: 'echoForm',
    name: 'Echo Form',
    ...
    upgraded: false,
    upgradedVersion: { ethereal: false, description: 'The first card you play each turn is played twice.' }
  },
  {
    id: 'electrodynamics',
