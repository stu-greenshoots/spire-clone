...
import { getKeywordsInText, KEYWORD_SPLIT_REGEX } from '../data/keywords';
...
const renderDescriptionWithKeywords = (text, small) => {
  ...
  // Use pre-compiled module-level regex instead of rebuilding per render
  const parts = text.split(KEYWORD_SPLIT_REGEX);
