...
import { SILENT_VICTORY_NARRATIVE, DEFECT_VICTORY_NARRATIVE, WATCHER_VICTORY_NARRATIVE } from '../data/bossDialogue';
...
const getVictoryText = (defeatedHeart, characterId) => {
  const narrative = characterId === 'silent' ? SILENT_VICTORY_NARRATIVE : characterId === 'defect' ? DEFECT_VICTORY_NARRATIVE : characterId === 'watcher' ? WATCHER_VICTORY_NARRATIVE : VICTORY_NARRATIVE;
